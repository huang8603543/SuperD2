...
namespace UniRx
{
    ...
    public static partial class Observable
    {
        ...
        public static IObservable<int> Do(this IObservable<int> source, Action<int> onNext)
        {
            return new DoObservable<int>(source, onNext, Stubs.Throw, Stubs.Nop);
        }

        public static IObservable<Unit> Do(this IObservable<Unit> source, Action<Unit> onNext)
        {
            return new DoObservable<Unit>(source, onNext, Stubs.Throw, Stubs.Nop);
        }
