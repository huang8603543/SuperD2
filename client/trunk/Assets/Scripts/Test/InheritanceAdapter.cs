...
public class TestClassBaseeAdapter : CrossBindingAdaptor
{
    ...
    public override Type AdaptorType
    {
        get
        {
            return typeof(TestClassBaseAdaptor);//这是实际的适配器类
        }
    }

    public override object CreateCLRInstance(ILRuntime.Runtime.Enviorment.AppDomain appdomain, ILTypeInstance instance)
    {
        return new TestClassBaseAdaptor(appdomain, instance);//创建一个新的实例
    }

    //实际的适配器类需要继承你想继承的那个类，并且实现CrossBindingAdaptorType接口
    class TestClassBaseAdaptor : TestClassBase, CrossBindingAdaptorType
    {
        ...
        public TestClassBaseAdaptor()
        {

        }

        public TestClassBaseAdaptor(ILRuntime.Runtime.Enviorment.AppDomain appdomain, ILTypeInstance instance)
        {
